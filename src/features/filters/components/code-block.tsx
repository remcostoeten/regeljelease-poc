...
const getBadgeClasses = ({ variant = "default", customClass }: TBadgeProps): string => {
  const base = "px-3 py-1 text-xs font-medium rounded-full transition-all duration-200 shrink-0 whitespace-nowrap shadow-sm";
            ...
            {badges.length > 0 && (
              <div className="relative flex-grow min-w-0 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
                <div
                  ...
                  onMouseLeave={() => setTimeout(() => setIsAutoScrolling(enableAutoScroll), 1000)}
                >
